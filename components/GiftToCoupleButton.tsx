  ...
  return (
    <>
      <button
        ...
        className={`inline-flex items-center justify-center gap-2 rounded-full px-7 py-3.5 text-sm font-semibold transition ${baseClass} ${className}`}
      >
        ...
        {open && (
          ...
          >
            <motion.div
              ...
              className="card-surface relative w-full max-w-md rounded-3xl p-6 sm:p-8"
